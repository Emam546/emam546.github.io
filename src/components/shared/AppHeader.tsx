    ...
    >
      <div className="z-10 block max-w-screen-lg py-6 xl:max-w-screen-xl sm:flex sm:justify-between sm:items-center">
        ...
        <div className="flex items-center justify-between px-4 sm:px-0">
          <Link href="/">
            <div className="flex items-start select-none gap-x-1">
              <Image
                src={logoDark}
                className="w-10 p-1 bg-gray-100 aspect-square dark:bg-gray-700"
                alt="Dark Logo"
              />
              <span className="mb-1 text-2xl font-medium dark:text-gray-200">
                ahmoud Imam
              </span>
            </div>
          </Link>
